          ...
          {roles.map((item) => (
            <button
              ...
              className={`px-3 sm:px-4 py-2 rounded-xl text-xs sm:text-sm font-medium transition ${
                role === item ? "bg-cyan-700 text-white" : "text-slate-600"
              }`}
            >
              {item}
            </button>
              ...
              >
                ...
                <td className="px-4 sm:px-5 py-4 whitespace-nowrap">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 sm:w-11 sm:h-11 rounded-full bg-cyan-600 text-white flex items-center justify-center font-bold text-sm">
                      {item.first_name
                        .split(" ")
                        .map((n) => n[0])
                        .join("")
